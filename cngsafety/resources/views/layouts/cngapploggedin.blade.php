...
<html class=" " lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <!--<link href="../assets/plugins/jvectormap/jquery-jvectormap-2.0.1.css" rel="stylesheet" type="text/css" media="screen"/> rehan change-->
...
<!--            <div class="chatapi-windows ">
        ...
        <!-- rehan change <script src="../assets/plugins/jvectormap/jquery-jvectormap-2.0.1.min.js" type="text/javascript"></script>
        ...
        <script src="../assets/plugins/echarts/echarts-custom-for-dashboard.js" type="text/javascript"></script>-->
         ...
         <script src="../assets/plugins/datatables/js/datatables.min.js" type="text/javascript">
