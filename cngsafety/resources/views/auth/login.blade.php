                ...
                <div id="login" class="login loginpage offset-xl-4 offset-lg-3 offset-md-3 offset-0 col-12 col-md-6 col-xl-4" >
                    ...
                    <form name="loginform" id="loginform" action="{{ route('login') }}" method="post">
                        ...
                        <p>
                            <label for="email">Email<br />
                                <input type="email" name="email" id="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}"  size="20" required autocomplete="off" /></label>
                    ...
                    <!--</form>-->
                        ...
                        <?php 
                            ...
                            else if ($route=="preworkshoplogin"){
                                $signup = route('workshoplogin') ;
                                
                            }
                            else if ($route=="prelablogin"){
                                $signup = route('laboratorylogin') ;
                    ...
                    <!--<p id="nav"></p>-->
                        ...
                        ?>
                        <p class="submit">
                            <input type="button" name="wp-button" id="wp-button" class="btn btn-success btn-block float-right" value="Sign Up"  
                            onclick="document.location.href= '<?php echo $signup; ?>' ;"/>
                        </p>
                    <?php  } ?>
                        <!--<a class="float-right" href="{{ $signup }}" title="Sign Up"><Strong> Sign Up</Strong></a>-->
